...
// Nouveau : Appeler la fonction de comptage d'articles définie dans check_session.php
// On passe le lien de base de données ($lien_base) et l'ID du client récupéré ci-dessus
        ...
        <header>
            ...
            <div class="navigation-icones">
                ...
                <a href="./panier.php">
                    ...
                    <!-- Nouveau : Affichage du badge contenant le nombre d'articles ($cart_count) -->
